  ...
  const fetchDepartment = async () => {
    try {
      ...
      if (response.ok) {
        ...
        showError("Error", "Failed to fetch department details");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        showError("Error", error.error || "Failed to update department");
      }
    } catch (error) {
          ...
          <div className={styles.headerFlex}>
            <div className={styles.headerLeft}>
              ...
              <div>
                ...
                <p className={styles.headerSubtitle}>Edit department information</p>
              </div>
            </div>
      ...
      <main className={styles.main}>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Update the department name and code below</CardDescription>
          </CardHeader>
          <CardContent>
